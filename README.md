file:///storage/emulated/0/Android/data/com.teejay.trebedit/files/TrebEdit%20user%20files/metasploit.sh#!/data/data/com.termux/files/usr/bin/bash
...
<div>git clone https://github.com/jasonxtn/argus.git
cd argus
docker build -t argus-recon:latest .
docker run -it --rm -v $(pwd)/results:/app/results argus-recon:latest</div><meta name="
git clone https://github.com/jasonxtn/argus.git
cd argus
chmod +x install.sh && ./install.sh
python -m argus    "/>https://github.com/termux/termux-packages/files/2912002/fix-ruby-bigdecimal.sh.txt)git clone https://github.com/jasonxtn/argus.git
cd argus
docker build -t argus-recon:latest .
docker run -it --rm -v $(pwd)/results:/app/results argus-recon:latestgit clone https://github.com/jasonxtn/argus.git
cd argus
chmod +x install.sh && ./install.sh
python -m argus
